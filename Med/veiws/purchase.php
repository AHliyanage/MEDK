...
<title>Purchase - MEDKNIGHT</title>
...
<!-------------- Topic ---------------->
	<div id="wrapper">
			<div id="Purchase">
				<table id="purchase" cellspacing="0" width="100%" class="display cell-border stripe">
...
<script>
	function load(){
		...
		xhttp.onreadystatechange = function() {
			if (this.readyState == 4 && this.status == 200) {
				...
				if(resp["success"]){
					...
					drawTable("purchase",resp["success"]);
				}else{
		...
		xhttp.open("POST","../controllers/purchaseMed.php", true);
		xhttp.send();
	}
</script>
