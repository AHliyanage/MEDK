...
<title>Manage Customer - MEDKNIGHT</title>
...
<!---------------------------------------------- Box Dashboard ------------------------------------------>
	...
	<section class="main-bar">
		<div class="main-bar-box">
			...
			<h6>Home / Customer / Manage customer</h6>
		</div>
	</section>
	...
	<div id="wrapper">
		<div id="tabs">
			...
			<div id="Update">
				...
				<div id="Customer2">
						<table id="customer2" cellspacing="0" width="100%" class="display cell-border stripe">
		...
		xhttp.onreadystatechange = function() {
			if (this.readyState == 4 && this.status == 200) {
				...
				if(resp["success"]){
					...
					drawTable("customer2",resp["success"]);
				}else{
