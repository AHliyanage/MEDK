...
function loadData(){
	...
	try{	
			...
			$conn = getConnection();
			$query = "SELECT product_name,discription,category,batch,purchase_unit,sales_unit,re_order_point,rack_no,supplier,company FROM product WHERE category='$type'";
